...
const unsigned int AutoRecordings::GetTimerIntIdFromStringId(const std::string &strId) const
{
  ...
  Logger::Log2(LogLevel::LEVEL_ERROR, "Autorec: Unable to obtain int id for string id %s", strId.c_str());
  return 0;
}
...
const std::string AutoRecordings::GetTimerStringIdFromIntId(unsigned int intId) const
{
  ...
  Logger::Log2(LogLevel::LEVEL_ERROR, "Autorec: Unable to obtain string id for int id %s", intId);
  return "";
}
...
PVR_ERROR AutoRecordings::SendAutorecAddOrUpdate(const PVR_TIMER &timer, bool update)
{
  ...
  const Settings &settings = Settings::GetInstance2();
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed %s response: 'success' missing", method.c_str());
...
PVR_ERROR AutoRecordings::SendAutorecDelete(const PVR_TIMER &timer)
{
  ...
  if (htsmsg_get_u32(m, "success", &u32))
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed deleteAutorecEntry response: 'success' missing");
  }
  htsmsg_destroy(m);
...
bool AutoRecordings::ParseAutorecAddOrUpdate(htsmsg_t *msg, bool bAdd)
{
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd/autorecEntryUpdate: 'id' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'enabled' missing");
    return false;
  }
  ...
  if (m_conn.GetProtocol() >= 25)
  {
    ...
    {
      Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'removal' missing");
      return false;
    }
  }
  else
  {
    ...
    {
      Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'retention' missing");
      return false;
    }
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'daysOfWeek' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'priority' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'start' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'startWindow' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'startExtra' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'stopExtra' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryAdd: 'dupDetect' missing");
    return false;
  }
...
bool AutoRecordings::ParseAutorecDelete(htsmsg_t *msg)
{
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed autorecEntryDelete: 'id' missing");
    return false;
  }
  Logger::Log2(LogLevel::LEVEL_TRACE, "delete autorec entry %s", id);
