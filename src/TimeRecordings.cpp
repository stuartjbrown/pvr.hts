...
const unsigned int TimeRecordings::GetTimerIntIdFromStringId(const std::string &strId) const
{
  ...
  Logger::Log2(LogLevel::LEVEL_ERROR, "Timerec: Unable to obtain int id for string id %s", strId.c_str());
  return 0;
}
...
const std::string TimeRecordings::GetTimerStringIdFromIntId(unsigned int intId) const
{
  ...
  Logger::Log2(LogLevel::LEVEL_ERROR, "Timerec: Unable to obtain string id for int id %s", intId);
  return "";
}
...
PVR_ERROR TimeRecordings::SendTimerecDelete(const PVR_TIMER &timer)
{
  ...
  if (htsmsg_get_u32(m, "success", &u32))
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed deleteTimerecEntry response: 'success' missing");
  }
  htsmsg_destroy(m);
...
bool TimeRecordings::ParseTimerecAddOrUpdate(htsmsg_t *msg, bool bAdd)
{
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd/timerecEntryUpdate: 'id' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'enabled' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'daysOfWeek' missing");
    return false;
  }
  ...
  if (m_conn.GetProtocol() >= 25)
  {
    ...
    {
      Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'removal' missing");
      return false;
    }
  }
  else
  {
    ...
    {
      Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'retention' missing");
      return false;
    }
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'priority' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'start' missing");
    return false;
  }
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryAdd: 'stop' missing");
    return false;
  }
...
bool TimeRecordings::ParseTimerecDelete(htsmsg_t *msg)
{
  ...
  {
    Logger::Log2(LogLevel::LEVEL_ERROR, "malformed timerecEntryDelete: 'id' missing");
    return false;
  }
  Logger::Log2(LogLevel::LEVEL_TRACE, "delete timerec entry %s", id);
